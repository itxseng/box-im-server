...
public class WebrtcPrivateController {
    ...
    @PostMapping("/setup")
    public Result<Void> setup(@RequestParam Long uid, @RequestParam(defaultValue = "video") String mode) {
    ...
    @PostMapping("/accept")
    public Result<Void> accept(@RequestParam Long uid) {
    ...
    @PostMapping("/reject")
    public Result<Void> reject(@RequestParam Long uid) {
    ...
    @PostMapping("/cancel")
    public Result<Void> cancel(@RequestParam Long uid) {
    ...
    @PostMapping("/failed")
    public Result<Void> failed(@RequestParam Long uid, @RequestParam String reason) {
    ...
    @PostMapping("/handup")
    public Result<Void> handup(@RequestParam Long uid) {
    ...
    @PostMapping("/offer")
    public Result<Void> offer(@RequestParam Long uid, @RequestBody String offer) {
    ...
    @PostMapping("/answer")
    public Result<Void> answer(@RequestParam Long uid, @RequestBody String answer) {
    ...
    public Result<Void> candidate(@RequestParam Long uid, @RequestBody String candidate) {
    ...
    public Result<Void> heartbeat(@RequestParam Long uid) {
